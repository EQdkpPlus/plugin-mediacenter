<?php
/*	Project:	EQdkp-Plus
 *	Package:	mc_latest_media Plugin
...
/*+----------------------------------------------------------------------------
  | mc_latest_media_portal
  +--------------------------------------------------------------------------*/
class mc_latest_media_portal extends portal_generic{

	/**
	* Portal path
	*/
	protected static $path = 'mc_latest_media';
	/**
	* Portal data
	*/
	protected static $data = array(
		...
		'description'	=> 'Displays latest Media from the MediaCenter',
		'lang_prefix'	=> 'mc_',
		'multiple'		=> true,
	);
	...
	*/
	public function output(){
		...
		$arrMedia = $this->pdh->sort($arrMedia, 'mediacenter_media', 'date', 'desc');
