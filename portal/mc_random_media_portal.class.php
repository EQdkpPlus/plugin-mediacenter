<?php
/*	Project:	EQdkp-Plus
 *	Package:	mc_random_media Plugin
...
/*+----------------------------------------------------------------------------
  | mc_random_media_portal
  +--------------------------------------------------------------------------*/
class mc_random_media_portal extends portal_generic{

	/**
	* Portal path
	*/
	protected static $path = 'mc_random_media';
	
	/**
	* Portal data
	*/
	protected static $data = array(
		'name'			=> 'Mediacenter Random Media Module',
		'version'		=> '0.1.0',
		'author'		=> 'GodMod',
		'contact'		=> 'https://eqdkp-plus.eu',
		'description'	=> 'Displays Randon Media from the MediaCenter',
		'lang_prefix'	=> 'mc_',
		'multiple'		=> true,
	);
